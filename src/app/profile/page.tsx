  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-8 py-8 space-y-10 pb-32 min-h-screen relative">
      ...
      <section className="space-y-10">
            ...
            <Dialog open={isEditDialogOpen} onOpenChange={setIsEditDialogOpen}>
              ...
              <DialogContent className="max-w-md rounded-[2.5rem] p-0 border-none bg-background w-[92vw] md:left-[calc(50%+8rem)] max-h-[90vh] flex flex-col">
                ...
                <div className="p-8 pt-0 space-y-6 overflow-y-auto flex-1">
                  <div className="grid grid-cols-2 gap-4">
                    <div className="space-y-1.5 text-left">
                      <Label className="text-[9px] font-black uppercase tracking-widest text-foreground opacity-60 ml-1">Weight (kg)</Label>
                    ...
                    <div className="space-y-1.5 text-left">
                      <Label className="text-[9px] font-black uppercase tracking-widest text-foreground opacity-60 ml-1">Height (cm)</Label>
                  ...
                  <div className="space-y-1.5 text-left">
                    <Label className="text-[9px] font-black uppercase tracking-widest text-foreground opacity-60 ml-1">Age</Label>
                ...
                <DialogFooter className="p-8 pt-0 shrink-0">
                  <Button onClick={handleUpdateProfile} disabled={loading} className="w-full h-14 rounded-2xl font-black text-sm shadow-xl uppercase tracking-widest text-foreground">
        ...
        <div className="pt-4">
          <Button onClick={handleLogout} className="w-full h-14 rounded-2xl font-black text-sm bg-red-600 hover:bg-red-700 text-white shadow-premium flex gap-3 transition-all">
